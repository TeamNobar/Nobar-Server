...
const SearchRecipesService_1 = require("../service/SearchRecipesService");
const StatusCode_1 = __importDefault(require("../utils/StatusCode"));
const errorMessage_1 = require("../utils/errorMessage");
let SearchRecipesController = class SearchRecipesController extends tsoa_1.Controller {
    findRecipesByBase(base) {
        return __awaiter(this, void 0, void 0, function* () {
            const recipes = yield new SearchRecipesService_1.SearchRecipesService().findRecipesByBase(base);
            if (recipes === null) {
...
], SearchRecipesController.prototype, "findRecipesByBase", null);
SearchRecipesController = __decorate([

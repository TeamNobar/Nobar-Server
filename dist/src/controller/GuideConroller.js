...
let GuideRouter = class GuideRouter extends tsoa_1.Controller {
    findGuide(guideId) {
...
], GuideRouter.prototype, "findGuide", null);
GuideRouter = __decorate([
    (0, tsoa_1.Route)("guide")
], GuideRouter);
exports.GuideRouter = GuideRouter;
//# sourceMappingURL=GuideConroller.js.map
...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { SearchRecipesByBaseController } from './../src/controller/SearchRecipesByBaseController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { TastingNoteController } from './../src/controller/TastingNoteController';
import { expressAuthentication } from './../src/auth/expressAuthentication';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/guide/:guideId',
            ...
            function GuideController_findGuide(request: any, response: any, next: any) {
            const args = {
        ...
        app.get('/mock',
            ...
            ...(fetchMiddlewares<RequestHandler>(MockController.prototype.getMock)),

            function MockController_getMock(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getMock.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/mypage',
            ...
            ...(fetchMiddlewares<RequestHandler>(MyPageController.prototype.getMypage)),

            function MyPageController_getMypage(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getMypage.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/search',
            ...
            function SearchKeywordController_getSearchKeywords(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new SearchKeywordController();


              const promise = controller.getSearchKeywords.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/search/base',
            ...
            function SearchRecipesByBaseController_findRecipesByBase(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const controller = new SearchRecipesByBaseController();


              const promise = controller.findRecipesByBase.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/search/keyword',
            ...
            function SearchRecipesByKeywordController_searchRecipesByKeyword(request: any, response: any, next: any) {
            const args = {
            ...
            try {
                ...
                const controller = new SearchRecipesByKeywordController();


              const promise = controller.searchRecipesByKeyword.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/search/tag',
            ...
            function SearchTagsController_getSearchTags(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new SearchTagsController();


              const promise = controller.getSearchTags.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/note/tag',
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController)),
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController.prototype.getAllTags)),

            function TastingNoteController_getAllTags(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new TastingNoteController();


              const promise = controller.getAllTags.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/note/:tastingNoteId',
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController)),
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController.prototype.getTastingNote)),

            function TastingNoteController_getTastingNote(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getTastingNote.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/note',
            authenticateMiddleware([{"jwt":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController)),
            ...(fetchMiddlewares<RequestHandler>(TastingNoteController.prototype.postTastingNote)),

            function TastingNoteController_postTastingNote(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.postTastingNote.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
